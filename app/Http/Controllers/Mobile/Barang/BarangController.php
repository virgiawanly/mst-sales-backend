...
namespace App\Http\Controllers\Mobile\Barang;

use App\Helpers\ResponseHelper;
use App\Http\Controllers\BaseResourceController;
use App\Http\Requests\Mobile\Barang\CreateBarangRequest;
use App\Http\Requests\Mobile\Barang\UpdateBarangRequest;
...
class BarangController extends BaseResourceController
{
     ...
     *
     * @param  \App\Http\Requests\Mobile\Barang\CreateBarangRequest  $request
     ...
     *
     * @param  \App\Http\Requests\Mobile\Barang\UpdateBarangRequest  $request
     * @param  int  $id
     * @return \Illuminate\Http\JsonResponse
     */
