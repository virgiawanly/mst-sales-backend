...
use App\Http\Requests\Mobile\Sales\CreateSalesRequest;
use App\Http\Requests\Mobile\Sales\UpdateSalesRequest;
...
class SalesController extends BaseResourceController
{
     ...
     *
     * @param  \App\Http\Requests\Mobile\Sales\CreateSalesRequest  $request
     * @return \Illuminate\Http\JsonResponse
     */
     ...
     *
     * @param  \App\Http\Requests\Mobile\Sales\UpdateSalesRequest  $request
     * @param  int  $id
     * @return \Illuminate\Http\JsonResponse
     */
